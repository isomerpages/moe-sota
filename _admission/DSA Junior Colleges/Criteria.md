...
Can non-Singaporeans apply under the DSA-JC category?</label>
    ...
    <div>
			<ul>
				...
				<li>If you are born in 2007 (16 years old) and will be completing Grade 10 by December 2023, you may apply via the Non-DSA category. Learn more about the Non-DSA Application Process.</li>
			</ul>
    </div>
	</li> 
	<li>
    <input id="accordion9" type="checkbox">
    <label for="accordion9">4. Must I have attended formal art lessons in order to apply? <br><br> 5. Must I have formal training and/or certification (ABRSM, RAD etc) in order to apply? </label>
    <div>
			<p>As you are applying for admission to Year 5, which is the first year of IB, you must have advanced skills in the art form that you are applying for. Please refer to the Preparation Notes and Checklist for the details.</p>
    </div>
	</li> 
	<li>
    <input id="accordion10" type="checkbox">
    <label for="accordion10">7. 
What are the eligibility criteria for successful admission to SOTA via DSA-JC</label>
    <div>
			<p>To gain admission into SOTA via DSA-JC, shortlisted applicants must satisfy the following criteria:</p>
			<ol>
				<li>Receive a Confirmed Offer for the final outcome of their Talent Academy application</li>
				<li>Exercise their option and submit the acceptance form to SOTA during the Acceptance Stage</li>
				<li>Qualify for the Junior College stream based on their ‘O’ Level examinations results</li>
			</ol>
    </div>
	</li> 
</ul>
  ...
  <li>
    ...
    <div>
      <ul>
				...
				<li>Please refer to the DSA-JC How To Apply&nbsp;tab for more information on application process and the timeline to take note of.</li>
			</ul>
    </div>
	</li>  
	<li>
    <input id="accordion16" type="checkbox">
    <label for="accordion16">4. I am not computer savvy and I don't know how to apply via the TA Portal. Can I come down to SOTA to seek assistance?</label>
    <div>
    ...
    <label for="accordion17">5. How do I upload videos to Youtube?</label>
    <div>
    ...
    <label for="accordion18">6. How do I upload videos and files to Google Drive?</label>
    <div>
    ...
    <label for="accordion19">7. How do I convert, compress or merge documents to PDF?</label>
    <div>
    ...
    <label for="accordion20">8. I would like to apply for DSA-JC but I am not available on the days of the Talent Academy (TA), can I be auditioned on a different date?<br><br>9. Can I choose the TA dates if I am shortlisted?</label>
    <div>
      <p>No. All auditions, assessments, and interviews must be done during the TA dates indicated. All TA schedules will be arranged by SOTA and no change of dates is allowed. Please refer to the DSA-JC How To Apply tab for more information on the application process and the timeline to take note of. We regret that due to the nature of the audition activities, no auditions will take place outside of the TA window.</p>
    </div>
	</li> 
</ul>
...
<ul class="jekyllcodex_accordion">
  <li>
    ...
    <label for="accordion24">1. I have attended the Talent Academy (TA). How do I find out the outcome of my TA?</label>
    <div>
      <p>You must log in to the TA Portal to check the status of your final TA outcome. Please refer to the DSA-JC How To Apply tab for more information on application process and the timeline to take note of.</p>
    </div>
	</li>  
	<li>
    <input id="accordion25" type="checkbox">
    <label for="accordion25">2. I have received a Confirmed Offer for my TA result. What do I do next?</label>
    <div>
      <ul>
	<li>You must exercise your option and submit the acceptance form to SOTA during the Acceptance Stage</li>
	<li>Qualify for the Junior College Stream based on your ‘O’ Level examinations results</li>
</ul>
    </div>
	</li>  
	<li>
    <input id="accordion26" type="checkbox">
    <label for="accordion26">3. I attended the Talent Academy (TA) but missed part of the TA activities on my schedule. Will that affect my chances of being selected?</label>
    <div>
    ...
    <label for="accordion27">4. I attended the Talent Academy (TA) but was not offered. Can I know why?</label>
    <div>
    ...
    <label for="accordion28">5. I attended the TA but was not offered. Can I request to be re-assessed?</label>
    <div>
    ...
    <label for="accordion29">6. I have attended the TA but was not offered. Can I apply again after 'O' Levels?</label>
    <div>
			<p>No, you may not apply again after 'O' levels as SOTA does not admit Year 5 pupils via the JAE exercise.</p>
    </div>
	</li> 
</ul>