...
<ul class="jekyllcodex_accordion">
  <li>
    ...
    <label for="accordion20">1. How do I apply and submit my application?<br><br>2. Do I have to submit any portfolio relevant to the art form that I wish to apply to?<br><br>3. Do I have to submit any supporting documents?</label>
    <div>
      <ul>
    ...
    <label for="accordion21">4. Do I have to submit an application via MOE DSA-Sec Portal?</label>
    <div>
    ...
    <label for="accordion22">5. I am not computer savvy and I don't know how to apply via the TA Portal. Can I come down to SOTA to seek assistance?</label>
    <div>
    ...
    <label for="accordion23">6. How do I upload videos to Youtube?</label>
    <div>
    ...
    <label for="accordion24">7. How do I upload videos and files to Google Drive?</label>
    <div>
    ...
    <label for="accordion25">8. How do I convert, compress or merge documents to PDF?</label>
    <div>
    ...
    <label for="accordion26">9. I would like to apply for DSA-Sec (Non-MOE) but I am not available on the days of the Talent Academy (TA), can I be auditioned on a different date?<br><br>10. Can I choose the TA dates if I am shortlisted?</label>
    <div>
...
<ul class="jekyllcodex_accordion">
  <li>
    ...
    <label for="accordion27">1. I have submitted my application via the TA Portal. How do I find out the outcome of my application?<br><br>2. I have been shortlisted to attend the TA. How do I find out which days I have been scheduled to attend?</label>
    <div>
      <p>Log in to the TA Portal and:</p>
			<ul>
				...
				<ul>
					...
					<li>Online questionnaires</li>
					<li>English and Maths entrance tests</li>
				</ul>
				...
				<li>Online questionnaires (same questionnaires for both shortlisted artforms, only required to take this ONCE)</li>
					<li>English and Maths entrance tests
</li>
			</ul>
    ...
    <label for="accordion28">3. I have downloaded my TA schedule and realised that I am not available on one of the dates allocated to me. Can I request for a change of date?</label>
    <div>
    ...
    <label for="accordion29">4. I have applied for Music (Performing) but was shortlisted for Music (Creating) instead. Can I appeal to be offered Music (Performing)?</label>
    <div>
    ...
    <label for="accordion30">5. I applied for the Talent Academy (TA) but was not shortlisted. Can I appeal?<br><br>6. I applied for the Talent Academy (TA) but was not shortlisted. Can I know why?</label>
    <div>
...
<ul class="jekyllcodex_accordion">
  <li>
    ...
    <label for="accordion31">1. I have attended the Talent Academy (TA). How do I find out the outcome of my TA?</label>
    <div>
    ...
    <label for="accordion32">2. I have received a Confirmed Offer for my TA result. What do I do next?</label>
    <div>
      <ul>
    ...
    <label for="accordion33">3. I attended the Talent Academy (TA) but missed part of the TA activities on my schedule. Will that affect my chances of being selected?</label>
    <div>
    ...
    <label for="accordion34">4. I attended the Talent Academy (TA) but was not offered. Can I know why?</label>
    <div>
    ...
    <label for="accordion35">5. I attended the TA but was not offered. Can I request to be re-assessed?</label>
    <div>
    ...
    <label for="accordion36">6. I attended the TA but was not offered. Can I re-apply again next year?</label>
    <div>
